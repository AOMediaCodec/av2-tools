...
bool ContentInterpretationOBU::parse_payload(std::ifstream& ifs) {
  ...
  // TODO: Implement CONTENT_INTERPRETATION parsing
  spdlog::warn("CONTENT_INTERPRETATION parsing not yet implemented");
  return true;
}
...
json ContentInterpretationOBU::to_json() const {
  ...
  // TODO: Add CONTENT_INTERPRETATION-specific fields
  return j;
}
