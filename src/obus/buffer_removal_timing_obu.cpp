...
bool BufferRemovalTimingOBU::parse_payload(std::ifstream& ifs) {
  ...
  // TODO: Implement BUFFER_REMOVAL_TIMING parsing
  spdlog::warn("BUFFER_REMOVAL_TIMING parsing not yet implemented");
  return true;
}
...
json BufferRemovalTimingOBU::to_json() const {
  ...
  // TODO: Add BUFFER_REMOVAL_TIMING-specific fields
  return j;
}
