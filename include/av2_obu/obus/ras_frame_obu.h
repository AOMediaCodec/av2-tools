...
// Random Access Switch Frame OBU (OBU_RAS_FRAME)
class RASFrameOBU : public BaseOBU {
public:
  explicit RASFrameOBU(const OBUPosition& pos) : BaseOBU(pos) {}

  json to_json() const override;
  std::string type_name() const override { return "RAS_FRAME"; }
